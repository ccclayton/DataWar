    ...
    this.generate = function () {
        if (layout_iterations < this.max_iterations && temperature > 0.000001) {
            ...
            for (var i = 0; i < nodes_length; i++) {
                ...
                var updated = true;
                //console.log(node.mesh.position.x -node.layout.tmp_pos_x);
...
//  this.attraction_multiplier = options.attraction || 1;//5 // r^2 smaller the stronger
//  this.repulsion_multiplier = options.repulsion || 5; //0.75;  // 1/r larger the stronger
//  this.max_iterations = options.iterations || 10000;
//  this.graph = graph;
...
//
//
//  this.use_weight = options.use_weight || false;
...
//   * the temperature is nearly zero.
//   */
//  this.generate = function(originPoint) {
//    // debugger
...
//        n.layout = n.layout || {};
//        n.layout.force = 0;
//        n.layout.offset_x = originPoint.x;
//        n.layout.offset_y = originPoint.y;
//        n.layout.offset_z = originPoint.z;
//
...
//        // n.layout.tmp_pos_z = 0;//n.position.z;
//
